...
Local mongoDB-server for newer versions of iOS works simply, if you create empty folder in your users folder. Starting up the server then will work just by running:
