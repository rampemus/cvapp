...
const renderProfileForm = (profile: IProfile, field: string) => <FormPanel
  formValues={{
    id: profile.id,
    name: profile.name,
...
const renderCommunicationForm = (communication: ICommunication, field: string) => <FormPanel
  formValues={{
    id: communication.id,
...
const renderInfoForm = (info: IInfo, field: string) => <FormPanel
  formValues={{
    id: info.id,
    name: info.name,
...
const renderContactForm = (contact: IContact, field: string) => <FormPanel
  formValues={{
    id: contact.id,
...
const renderProjectForm = (project: IProject, field: string) => <FormPanel
  formValues={{
    id: project.id,
...
const renderExperienceForm = (experience: IExperience, field: string) => <FormPanel
  formValues={{
    id: experience.id,
...
const MyCVForm: React.FC<OwnProps> = (props) => {
  ...
  if (cv) {
    return <div className='cvFormContainer'>
